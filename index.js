...
function profitLoss(market_price, quantity , selling_price){
    if(market_price.value < selling_price.value )
    {
        var profit = (selling_price.value - market_price.value)*quantity.value;
    ...
    else if(market_price.value > selling_price.value)
    {
        var loss = ( market_price.value - selling_price.value )*quantity.value;
        var lossPercent = (loss/selling_price.value)*100; 
